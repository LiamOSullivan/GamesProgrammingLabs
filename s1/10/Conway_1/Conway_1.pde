...
void glider(){
  int row = (int) (mouseY / cellWidth);
  int col = (int) (mouseX / cellHeight);
  board[row][col+1] = true; // top center
  board[row+1][col+2] = true; //middle, right
  board[row+2][col] = true; //bottom, left
  board[row+2][col+1] = true; //bottom, center
  board[row+2][col+2] = true; //bottom, right
